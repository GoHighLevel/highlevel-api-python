...
class FormsSubmissionsSubmissionsSchema(BaseModel):
...
class FormsSubmissionsSuccessfulResponseDto(BaseModel):
    """FormsSubmissionsSuccessfulResponseDto model"""
    submissions: Optional[List[FormsSubmissionsSubmissionsSchema]] = None
    meta: Optional[metaSchema] = None

class FormsParams(BaseModel):
    """FormsParams model"""
    id: Optional[str] = None
    name: Optional[str] = None
    locationId: Optional[str] = None

class FormsSuccessfulResponseDto(BaseModel):
    """FormsSuccessfulResponseDto model"""
    forms: Optional[List[FormsParams]] = None
    total: Optional[float] = None
