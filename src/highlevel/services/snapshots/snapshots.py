...
class Snapshots:
    ...
    async def get_custom_snapshots(
        self,
        company_id: str,
    ...
    async def create_snapshot_share_link(
        self,
        company_id: str,
        request_body: CreateSnapshotShareLinkRequestDTO,
        options: Optional[Dict[str, Any]] = None
        ...
        config: RequestConfig = {
            "method": "POST",
            "url": build_url("/snapshots/share/link", extracted["path"]),
            "params": extracted["query"],
            "headers": {**extracted["header"], **(options.get("headers", {}) if options else {})},
            "data": request_body,
            "__security_requirements": requirements,
    ...
    async def get_latest_snapshot_push(
        self,
        company_id: str,
        snapshot_id: str,
        location_id: str,
        ...
        """
        param_defs = [{"name": "companyId", "in": "query"}, {"name": "snapshotId", "in": "path"}, {"name": "locationId", "in": "path"}, ]
        extracted = extract_params({ "company_id": company_id, "snapshot_id": snapshot_id, "location_id": location_id,  }, param_defs)
        requirements = ["Agency-Access"]
        
        config: RequestConfig = {
            "method": "GET",
            "url": build_url("/snapshots/snapshot-status/{snapshotId}/location/{locationId}", extracted["path"]),
            "params": extracted["query"],
            "headers": {**extracted["header"], **(options.get("headers", {}) if options else {})},
