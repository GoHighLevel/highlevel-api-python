...
class Locations:
    ...
    async def search_locations(
        ...
        """
        param_defs = [{"name": "companyId", "in": "query"}, {"name": "skip", "in": "query"}, {"name": "limit", "in": "query"}, {"name": "order", "in": "query"}, {"name": "email", "in": "query"}]
        extracted = extract_params({ "company_id": company_id, "skip": skip, "limit": limit, "order": order, "email": email }, param_defs)
        requirements = ["Agency-Access","Location-Access"]
        
        config: RequestConfig = {
            "method": "GET",
            "url": build_url("/locations/search", extracted["path"]),
    ...
    async def get_location(
        ...
        config: RequestConfig = {
            "method": "GET",
            "url": build_url("/locations/{locationId}", extracted["path"]),
            "params": extracted["query"],
            "headers": {**extracted["header"], **(options.get("headers", {}) if options else {})},
    ...
    async def delete_location(
        ...
        """
        param_defs = [{"name": "locationId", "in": "path"}, {"name": "deleteTwilioAccount", "in": "query"}]
        extracted = extract_params({ "location_id": location_id, "delete_twilio_account": delete_twilio_account }, param_defs)
        requirements = ["Agency-Access"]
    ...
    async def get_location_permissions(
        ...
        config: RequestConfig = {
            "method": "GET",
            "url": build_url("/locations/{locationId}/permissions", extracted["path"]),
            "params": extracted["query"],
            "headers": {**extracted["header"], **(options.get("headers", {}) if options else {})},
    ...
    async def get_location_tags(
        ...
        config: RequestConfig = {
            "method": "GET",
            "url": build_url("/locations/{locationId}/tags", extracted["path"]),
            "params": extracted["query"],
            "headers": {**extracted["header"], **(options.get("headers", {}) if options else {})},
    ...
    async def get_tag_by_id(
        ...
        Get tag by id
        """
        param_defs = [{"name": "locationId", "in": "path"}, {"name": "tagId", "in": "path"}]
        extracted = extract_params({ "location_id": location_id, "tag_id": tag_id }, param_defs)
        requirements = ["bearer"]
        
        config: RequestConfig = {
            "method": "GET",
            "url": build_url("/locations/{locationId}/tags/{tagId}", extracted["path"]),
            "params": extracted["query"],
            "headers": {**extracted["header"], **(options.get("headers", {}) if options else {})},
    ...
    async def task_search(
        self,
        location_id: str,
        request_body: TaskSearchParamsDto,
        options: Optional[Dict[str, Any]] = None
        ...
        config: RequestConfig = {
            "method": "POST",
            "url": build_url("/locations/{locationId}/tasks/search", extracted["path"]),
            "params": extracted["query"],
            "headers": {**extracted["header"], **(options.get("headers", {}) if options else {})},
            "data": request_body,
            "__security_requirements": requirements,
    ...
    async def get_recurring_task_by_id(
        ...
        config: RequestConfig = {
            "method": "GET",
            "url": build_url("/locations/{locationId}/recurring-tasks/{id}", extracted["path"]),
            "params": extracted["query"],
            "headers": {**extracted["header"], **(options.get("headers", {}) if options else {})},
    ...
    async def update_recurring_task(
        ...
        id: str,
        location_id: str,
        request_body: RecurringTaskUpdateDTO,
        options: Optional[Dict[str, Any]] = None
    ) -> RecurringTaskSingleResponseDTO:
        """
    ...
    async def create_recurring_task(
        self,
        location_id: str,
        request_body: RecurringTaskCreateDTO,
        options: Optional[Dict[str, Any]] = None
    ) -> RecurringTaskSingleResponseDTO:
        """
        ...
        config: RequestConfig = {
            "method": "POST",
            "url": build_url("/locations/{locationId}/recurring-tasks", extracted["path"]),
            "params": extracted["query"],
            "headers": {**extracted["header"], **(options.get("headers", {}) if options else {})},
            "data": request_body,
            "__security_requirements": requirements,
    ...
    async def get_custom_fields(
        ...
        Get Custom Fields
        """
        param_defs = [{"name": "locationId", "in": "path"}, {"name": "model", "in": "query"}]
        extracted = extract_params({ "location_id": location_id, "model": model }, param_defs)
        requirements = ["bearer"]
        
        config: RequestConfig = {
            "method": "GET",
            "url": build_url("/locations/{locationId}/customFields", extracted["path"]),
            "params": extracted["query"],
            "headers": {**extracted["header"], **(options.get("headers", {}) if options else {})},
    ...
    async def get_custom_field(
        ...
        config: RequestConfig = {
            "method": "GET",
            "url": build_url("/locations/{locationId}/customFields/{id}", extracted["path"]),
            "params": extracted["query"],
            "headers": {**extracted["header"], **(options.get("headers", {}) if options else {})},
    ...
    async def upload_file_custom_fields(
        self,
        location_id: str,
        ...
        config: RequestConfig = {
            "method": "POST",
            "url": build_url("/locations/{locationId}/customFields/upload", extracted["path"]),
            "params": extracted["query"],
            "headers": {**extracted["header"], **(options.get("headers", {}) if options else {})},
            "data": request_body,
            "__security_requirements": requirements,
    ...
    async def get_custom_values(
        ...
        config: RequestConfig = {
            "method": "GET",
            "url": build_url("/locations/{locationId}/customValues", extracted["path"]),
            "params": extracted["query"],
            "headers": {**extracted["header"], **(options.get("headers", {}) if options else {})},
    ...
    async def get_custom_value(
        ...
        config: RequestConfig = {
            "method": "GET",
            "url": build_url("/locations/{locationId}/customValues/{id}", extracted["path"]),
            "params": extracted["query"],
            "headers": {**extracted["header"], **(options.get("headers", {}) if options else {})},
    ...
    async def get_timezones(
        ...
        config: RequestConfig = {
            "method": "GET",
            "url": build_url("/locations/{locationId}/timezones", extracted["path"]),
            "params": extracted["query"],
            "headers": {**extracted["header"], **(options.get("headers", {}) if options else {})},
    ...
    async def g_e_t_all_or_email_sms_templates(
        self,
        origin_id: str,
        location_id: str,
        ...
        GET all or email/sms templates
        """
        param_defs = [{"name": "deleted", "in": "query"}, {"name": "skip", "in": "query"}, {"name": "limit", "in": "query"}, {"name": "type", "in": "query"}, {"name": "originId", "in": "query"}, {"name": "locationId", "in": "path"}]
        extracted = extract_params({ "deleted": deleted, "skip": skip, "limit": limit, "type": type, "origin_id": origin_id, "location_id": location_id }, param_defs)
        requirements = ["bearer"]
        
        config: RequestConfig = {
            "method": "GET",
            "url": build_url("/locations/{locationId}/templates", extracted["path"]),
            "params": extracted["query"],
            "headers": {**extracted["header"], **(options.get("headers", {}) if options else {})},
    ...
    async def d_e_l_e_t_e_an_email_sms_template(
        self,
        location_id: str,
        id: str,
        options: Optional[Dict[str, Any]] = None
        ...
        config: RequestConfig = {
            "method": "DELETE",
            "url": build_url("/locations/{locationId}/templates/{id}", extracted["path"]),
            "params": extracted["query"],
            "headers": {**extracted["header"], **(options.get("headers", {}) if options else {})},
...
&lt;span&gt;
 ...
 &lt;/span&gt;
        ...
        config: RequestConfig = {
            "method": "POST",
            "url": build_url("/locations/", extracted["path"]),
            "params": extracted["query"],
            "headers": {**extracted["header"], **(options.get("headers", {}) if options else {})},
            "data": request_body,
            "__security_requirements": requirements,
    ...
    async def get_conversation_channel(
        self,
        location_id: str,
        type: str,
        options: Optional[Dict[str, Any]] = None
        ...
        """
        param_defs = [{"name": "locationId", "in": "path"}, {"name": "type", "in": "path"}]
        extracted = extract_params({ "location_id": location_id, "type": type }, param_defs)
        requirements = ["Location-Access"]
        
        config: RequestConfig = {
            "method": "GET",
            "url": build_url("/locations/{locationId}/conversationChannels/{type}", extracted["path"]),
            "params": extracted["query"],
            "headers": {**extracted["header"], **(options.get("headers", {}) if options else {})},
