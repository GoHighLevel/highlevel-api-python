...
class Links:
    ...
    async def get_link_by_id(
        ...
        """
        param_defs = [{"name": "locationId", "in": "query"}, {"name": "linkId", "in": "path"}]
        extracted = extract_params({ "location_id": location_id, "link_id": link_id }, param_defs)
        requirements = ["bearer"]
        
        config: RequestConfig = {
            "method": "GET",
            "url": build_url("/links/id/{linkId}", extracted["path"]),
    ...
    async def update_link(
        ...
        Update Link
        """
        param_defs = [{"name": "linkId", "in": "path"}]
        extracted = extract_params({ "link_id": link_id }, param_defs)
        requirements = ["bearer"]
        
        config: RequestConfig = {
            "method": "PUT",
            "url": build_url("/links/{linkId}", extracted["path"]),
            "params": extracted["query"],
            "headers": {**extracted["header"], **(options.get("headers", {}) if options else {})},
            "data": request_body,
            "__security_requirements": requirements,
    ...
    async def search_trigger_links(
        self,
        location_id: str,
        ...
        """
        param_defs = [{"name": "locationId", "in": "query"}, {"name": "query", "in": "query"}, {"name": "skip", "in": "query"}, {"name": "limit", "in": "query"}]
        extracted = extract_params({ "location_id": location_id, "query": query, "skip": skip, "limit": limit }, param_defs)
        requirements = ["bearer"]
        
        config: RequestConfig = {
            "method": "GET",
            "url": build_url("/links/search", extracted["path"]),
            "params": extracted["query"],
            "headers": {**extracted["header"], **(options.get("headers", {}) if options else {})},
    ...
    async def get_links(
        ...
        config: RequestConfig = {
            "method": "GET",
            "url": build_url("/links/", extracted["path"]),
            "params": extracted["query"],
            "headers": {**extracted["header"], **(options.get("headers", {}) if options else {})},
